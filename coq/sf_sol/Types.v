...
Proof.
  ...
  - unfold step_normal_form. unfold not.
    ...
    inversion H2.
  - unfold value. unfold not. intros.
...
Proof.
  unfold value. unfold step_normal_form. unfold not.
  intros. destruct H.
  - inversion H0. inversion H. subst. inversion H1.
    subst. inversion H1.
  - inversion H0.
    generalize dependent x. induction H.
    + intros. inversion H1.
...
Proof with auto.
  ...
  - (* T_Succ *)
    ...
    + left. apply nat_canonical in H.
      unfold value. right. apply nv_succ. apply H. apply HT.
    + right. inversion H as [t1' H1].
      exists (tsucc t1')...
  - (* T_Pred*)
    inversion IHHT; clear IHHT.
    + right. apply nat_canonical in H. inversion H.
      exists tzero... exists t... apply HT.
    + right. inversion H. exists (tpred x)...
  - (* T_Iszero *)
    inversion IHHT; clear IHHT.
    + right. apply nat_canonical in H. inversion H.
      exists (ttrue)... exists (tfalse)... apply HT.
...
Proof with auto.
  ...
  induction HT;
    ...
    - inversion HE; subst; clear HE.
      apply T_Succ. apply IHHT. apply H0.
    - inversion HE; subst; clear HE.
      apply T_Zero.
      inversion HT. apply H1.
      apply T_Pred. apply IHHT. apply H0.
    - inversion HE; subst; clear HE.
      apply T_True.
      apply T_False.
...
Proof with eauto.
  ...
  generalize dependent T.
  induction HStep; intros; inversion HT; subst...
